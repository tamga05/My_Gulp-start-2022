...
const ghPages = require('gulp-gh-pages'); // РАСКОММЕНТИРОВАТЬ ЭТУ СТРОКУ (если она закомментирована) для Создания Сайта на gh-pages и "Деплоя" на этот сайт моего проекта.
